# Information Needed from the Board to Finalize clrhoa.com

This is a **simple request** you can send to the board. They can reply by filling in the blanks or listing the info—no technical knowledge needed.

---

## Ready-to-Send Email (copy and paste)

**Subject:** Info needed to finish the new HOA website — please reply when you can
...
### 4. Optional (only if you have it handy)

- **Eustis Community Center:** Full street address for the annual meeting (for maps/directions).
- **Dues:** Confirm that dues are due Jan, Apr, Jul, Oct and that payment instructions (where to send, etc.) are correct—or tell us what to say.
